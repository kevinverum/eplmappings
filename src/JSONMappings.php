    ...
    public static function map():array
    {
        return  [
            ...
            "wp_postmeta" => array_filter([
                "property_custom_commercial_rent" => "",
                ...
                "property_bus_category" => "",
                "property_bus_category_2" => "",
                "property_bus_category_3" => "",
                "property_bus_sub_category" => "",
                "property_bus_sub_category_2" => "",
                "property_bus_sub_category_3" => "",
